...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    private TextView flashLightTv,scan,gallery;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences mSharedPreferences  =  PreferenceManager.getDefaultSharedPreferences(this);
         language  = mSharedPreferences.getString("language_settings","-1");
    ...
    private void initView() {
        ...
        if("en".equals(language)){
            flashLightTv.setText("Turn on the flash");
    ...
    public void switchFlashImg(int flashState) {
        ...
        if (flashState == Constant.FLASH_OPEN) {
            ...
            if("en".equals(language)){
                flashLightTv.setText("Turn off the flash");
            }else if ("cn".equals(language)){
                flashLightTv.setText("关闭闪光灯");
            }else if("ko".equals(language)){
                flashLightTv.setText("플래시 끄기");
            }
