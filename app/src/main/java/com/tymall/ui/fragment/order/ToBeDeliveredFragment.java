 ...
 * 待发货
 */
public class ToBeDeliveredFragment extends XBaseFragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    private void getOrderList() {
        ServerApi.getInstance().getOrderList(getContext(), pageCount, "201")
