 ...
 * 待收货
 */
public class PendingReceiptFragment extends XBaseFragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    protected void initView() {
        ...
        adapter.set_OnItemClickListener(new OrderAdapter.OnItemClickListener() {
            ...
            public void onItemClickTwo(View view, int position) {
                ...
                //待收货--确认收货
                if (orderListBean.getOrderStatus() == 202) {
    ...
    private void getOrderList() {
        ServerApi.getInstance().getOrderList(getContext(), pageCount, "202")
                .subscribeOn(Schedulers.io())
                .doOnSubscribe(new Consumer<Disposable>() {
                    @Override
                    public void accept(@NonNull Disposable disposable) throws Exception {
    ...
    private void showPromptDialog(String orderId) {
        String contentString = cnt.getResources().getString(R.string.determine_the_receipt);
