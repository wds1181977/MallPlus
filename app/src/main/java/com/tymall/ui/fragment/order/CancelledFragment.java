 ...
 * 已取消
 */
public class CancelledFragment extends XBaseFragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    private void getOrderList() {
        ServerApi.getInstance().getOrderList(getContext(), pageCount, "101")
