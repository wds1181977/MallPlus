package com.tymall.utils.update;
...
/**
 * Created by zoujiamin on 2018/11/27.
 */
...
//            sHorizontalProgressDialog.setProgressDrawable(context.getResources().getDrawable(R.drawable.progressbar));
