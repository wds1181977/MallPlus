...
public class ApiException extends Exception {
    ...
    public static ApiException handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            ex.message = MyApplication.getInstance().getString(R.string.string_json_data_erro);
            return ex;
        } else if (e instanceof ClassCastException) {
            ex = new ApiException(e, ERROR.CAST_ERROR);
            ex.message = MyApplication.getInstance().getString(R.string.string_type_data_erro);
            return ex;
        } else if (e instanceof ConnectException) {
            ex = new ApiException(e, ERROR.NETWORD_ERROR);
            ex.message = MyApplication.getInstance().getString(R.string.string_connect_fail);
            return ex;
        } else if (e instanceof javax.net.ssl.SSLHandshakeException) {
            ex = new ApiException(e, ERROR.SSL_ERROR);
            ex.message = MyApplication.getInstance().getString(R.string.string_ssl_error_title);
            return ex;
        } else if (e instanceof ConnectTimeoutException) {
            ex = new ApiException(e, ERROR.TIMEOUT_ERROR);
            ex.message = MyApplication.getInstance().getString(R.string.string_socket_time_out);
            return ex;
            ...
            ex.message = MyApplication.getInstance().getString(R.string.string_network_error_exception);
            return ex;
            ...
            ex.message = "";
            // ex.message = MyApplication.getInstance().getString(R.string.string_no_konw_erro);
            return ex;
        }
    }
