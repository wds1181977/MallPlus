...
public class RxEasyHttp {
    ...
    private static class SingletonHolder {
        ...
        private static final RxEasyHttp INSTANCE = new RxEasyHttp();
    ...
    public static final RxEasyHttp getInstance() {

        return RxEasyHttp.SingletonHolder.INSTANCE;
    ...
    public void init(Application app) {
        ...
        EasyHttp.getInstance()
                ...
                .debug("EasyHttp", MyApplication.isLog)
