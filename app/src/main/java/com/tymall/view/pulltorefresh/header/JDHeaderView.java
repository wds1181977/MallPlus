package com.tymall.view.pulltorefresh.header;
...
import com.tymall.view.pulltorefresh.PtrUIHandler;
import com.tymall.view.pulltorefresh.indicator.PtrIndicator;
...
public class JDHeaderView extends PtrFrameLayout implements PtrUIHandler {
    ...
    private void initView() {
        ...
        View view = View.inflate(this.getContext(), R.layout.headerviewlayout,null);
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        if(frame.isPullToRefresh()){
            status_text.setText(R.string.string_dbmall_novigation_release_refresh);
        }else{
            status_text.setText(R.string.string_dbmall_novigation_pull_down_to_refresh);
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        ...
        drawable.start();
        status_text.setText(R.string.string_dbmall_novigation_refreshing);
    }
